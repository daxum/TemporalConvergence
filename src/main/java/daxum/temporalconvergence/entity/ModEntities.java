...
public final class ModEntities {
	public static void init() {
		...
		EntityRegistry.registerModEntity(new ResourceLocation(TemporalConvergence.MODID, "lunar_boomerang"), EntityLunarBoomerang.class, "lunar_boomerang", id++, TemporalConvergence.instance, 128, 4, true);
	}
}
