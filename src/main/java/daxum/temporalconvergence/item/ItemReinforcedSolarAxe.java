...
public class ItemReinforcedSolarAxe extends ItemAxe {
	public ItemReinforcedSolarAxe() {
		super(ModItems.REINFORCED_SOLAR, 7.0f, -3.1f);
		setCreativeTab(ModItems.TEMPCONVTAB);
		setUnlocalizedName("reinforced_solar_axe");
		setRegistryName("reinforced_solar_axe");
	}
