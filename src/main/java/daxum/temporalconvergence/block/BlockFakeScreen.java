...
public class BlockFakeScreen extends BlockBase {
	...
	public BlockFakeScreen() {
		super(Material.BARRIER, "fake_boss_screen", -1.0f, Float.MAX_VALUE, "", 0, SoundType.METAL);
	...
	public IBlockState getStateFromMeta(int meta) {
		return getDefaultState().withProperty(FACING, EnumFacing.getHorizontal(meta & 3)).withProperty(TOP, (meta & 4) == 4);
	}
