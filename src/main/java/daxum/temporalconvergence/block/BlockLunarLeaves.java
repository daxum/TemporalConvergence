...
public class BlockLunarLeaves extends BlockLeaves {
	public BlockLunarLeaves() {
		setUnlocalizedName("lunar_leaves");
		setRegistryName("lunar_leaves");
	...
	public EnumType getWoodType(int meta) {
		return EnumType.OAK; //not used
	}

	@Override
	public Item getItemDropped(IBlockState state, Random rand, int fortune) {
		return Item.getItemFromBlock(ModBlocks.LUNAR_SAPLING);
	}
