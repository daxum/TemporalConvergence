...
public class TileCrafterRenderer extends TileEntitySpecialRenderer<TileCrafter> {

	@Override
	public void render(TileCrafter te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
