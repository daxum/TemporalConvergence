...
import daxum.temporalconvergence.render.tileentity.TileFutureChestRenderer;
...
public final class EntityRenderRegister {
	...
	public static void initTileEntity() {
		...
		ClientRegistry.bindTileEntitySpecialRenderer(TileFutureChest.class, new TileFutureChestRenderer());
	}
}
